...
FeatureOverlay(st_q3, features = c("new_groups"),  ncols = 2, sampleids = 1:6,
               pt.size = 1.3, cols = c(rest = "#003366",   # Azul oscuro
...
# Create and save combined boxplots for meta_q3
combined_boxplots_meta_q3 <- create_combined_boxplots(meta_q3, variables_to_plot, "new_groups", colors_palette)
pdf("./results/new_grouping/combined_boxplots_meta_q3_together.pdf", width = 7, height = 10)
do.call(grid.arrange, c(combined_boxplots_meta_q3, ncol = 1))
dev.off()
...
combined_plots_PC_TcellExh <- plot_grid(plotlist = plots_PC_TcellExh, ncol = 1)

pdf("./results/new_grouping/correlation_meta_q3_pcvstex.pdf", width = 5, height = 10)
...
combined_plots_PC_Teff <- plot_grid(plotlist = plots_PC_Teff, ncol = 1)

pdf("./results/new_grouping/correlation_meta_q3_pcvsteff.pdf", width = 5, height = 10)
